...
nepoch = 300
niter_target = 2000
subfolder = f'{nepoch}epochs'
nvoxelx = 250  # set problem size
filename = f'{filename}_{nvoxelx}x{nvoxelx}'

folder_main = f'{folder_out}/{filename}'
if not os.path.exists(folder_main):
    os.makedirs(folder_main)

folder_today = f'{folder_main}/{subfolder}'
if not os.path.exists(folder_today):
    os.makedirs(folder_today)

folder_npy = f'{folder_today}/npy'
...
file_data = f'{folder_main}/data.npy'
if not os.path.exists(file_data):
    ...
    fig2.savefig(f'{folder_main}/components1D.png', bbox_inches='tight')
...
file_target = f'{folder_main}/target.npy'
if not os.path.exists(file_target):
    file_normA = f'{folder_main}/norms_1subsets.npy'
